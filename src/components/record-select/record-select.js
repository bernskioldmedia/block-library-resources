 ...
 */
function RecordSelector( { onChange, value, multiple, placeholder, isRequesting, type, records } ) {
...
export default withSelect( ( select, props ) => {
	...
	return {
		...
		isRequesting: isResolving( "core", "getEntityRecords", [ entityType, objectType, query ] )
	};
